...
(doom! :input
       ...
       vertico ;;(vertico +icons)           ; the search engine of the future
       ...
       ibuffer ;;(ibuffer +icons)         ; interactive buffer management
       ...
       (org +crypt +dragndrop +pandoc +noter +present +pretty +roam)               ; organize your plain life in plain text
