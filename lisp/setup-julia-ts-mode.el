;;; ~/.doom.d/lisp/setup-julia-ts-mode.el --- Configure julia-ts-mode -*- lexical-binding: t; -*-
...
;;   (add-hook 'julia-ts-mode-hook (lambda () (highlight-numbers-mode -1)))
  ...
  ;; (add-hook! julia-ts-mode
  ;;            ;; (setq flyspell-mode nil)
  ;;            (setq flycheck-mode -1))
  ;; (add-hook 'julia-ts-mode-hook (lambda () (flyspell-mode nil)))
  ;; (add-hook 'julia-ts-mode-hook (lambda () (flycheck-mode -1)))

  (set-company-backend! 'julia-ts-mode
